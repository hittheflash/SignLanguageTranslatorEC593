...
def lstm_build(nFramesNorm:int, nFeatureLength:int, nClasses:int, fDropout:float = 0.5) -> keras.models.Model:
...
def lstm_load(sPath:str, nFramesNorm:int, nFeatureLength:int, nClasses:int) -> keras.models.Model:
